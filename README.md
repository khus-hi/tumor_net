...
----------------------------------------------------------------------------------------------------------------------------------
| ViT      | Best accuracy, global attention, handles complex patterns well  | Less interpretable (no Grad-CAM by default)       |
|ResNet-50 | Strong CNN baseline, excellent Grad-CAM maps                    | Slightly lower accuracy on complex MRI datasets   |
----------------------------------------------------------------------------------------------------------------------------------
